            ...
            : base(tcpClient, Config.BufferSizes.ClientBound, (ulong)DateTime.UtcNow.Ticks)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    {
                        if (GatewayConfig.InDebug) _logger.LogWarning(ex, "Exception during login process");
                        throw;
                    }
                    finally
                    {
        ...
        public Task ReceiveTilClosedAndDispose()
        {
            return Task.Run(() =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (GatewayConfig.Debug.LogServerInvalidDataException && ex is InvalidDataException)
